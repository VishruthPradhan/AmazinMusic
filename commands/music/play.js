...
let rowss = new MessageActionRow()
                ...
                if (serverQueue) {
                    ...
                    if (playlist) return undefined;
                        ...
                        const sembed = new MessageEmbed()
                            ...
                            .setTimestamp()
                            .setImage("https://i.pinimg.com/originals/cd/83/e3/cd83e34992570d14493c163c3ff3d42d.gif")
  ...
  const serverQueue = ops.queue.get(message.guild.id);
                ...
                const embed = new MessageEmbed()
                    ...
                    .setThumbnail(song.thumbnail)
                    .setTimestamp()
                    .setImage("https://cdn.discordapp.com/attachments/938640806812737566/947479998175010816/AZL7.gif")
