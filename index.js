...
client.on("message", async message => {
  ...
  if (message.content.match(prefixMention)) {
    ...
    let embed = new MessageEmbed()
        ...
        Bot Prefix: \`${prefix}\`
        Invite Link: [Click Here](https://discord.com/oauth2/authorize?client_id=947469177495629834&scope=bot&permissions=1071661309896)

        :question: Still need help? [Click Here](https://discord.gg/fqSy6wtW6a) to join server
        `)
...
require('http').createServer((req, res) => res.end(`
 ...
 |• Author: Supreme#2401                   |
 |-----------------------------------------|
 |• Server: https://discord.gg/fqSy6wtW6a  |
 |-----------------------------------------|
 |• Github: github.com/VishruthPradhan     |
 |-----------------------------------------|
